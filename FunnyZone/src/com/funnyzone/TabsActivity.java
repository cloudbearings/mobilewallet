...
import com.funnyzone.adapters.NavDrawerListAdapter;
import com.funnyzone.beans.NavDrawerItem;
import com.funnyzone.dao.CategoriesDAO;
import com.funnyzone.gcm.GcmRegistration;
...
public class TabsActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			/*
			 * try { if (Utils.openAd(TabsActivity.this)) { new
			 * AdController().interstitialAd(TabsActivity.this,
			 * getString(R.string.home_interstitial_unit_id)); } } catch
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		 ...
		 * case R.id.refresh_posts: HomePostsThread thread = new
		 * HomePostsThread(TabsActivity.this); thread.run(); return true;
