...
public class ForgotPassword extends ActionBarActivity {
	...
	public void onResume() {
		super.onResume();
		Utils.googleAnalyticsTracking(ForgotPassword.this,
				getString(R.string.forgot_pwd_screen_name));
	}
	...
	private void forgotPassword() {
		...
		if (validate()) {
			if (!clicked) {
				...
				BuildService.build.fp(emailEditText.getText().toString().trim()
						.toLowerCase(Locale.ENGLISH), new Callback<String>() {
	...
	private boolean validate() {
		if (!(Patterns.EMAIL_ADDRESS).matcher(
				emailEditText.getText().toString().trim()).matches()) {
