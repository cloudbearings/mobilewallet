...
public class HomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
	...
	private List<NavDrawerItem> categories;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		try {
			...
			hmProgressBar = (ProgressBar) view.findViewById(R.id.hm_progress_bar);
			...
			categories = categoriesDAO.getHomeCategories();
	...
	private void getHomePostsFromSqlite(NavDrawerItem category, int i) {
		try {
			hmProgressBar.setVisibility(View.GONE);
			rowItems = homeDAO.getfivePosts(category.getId(), category.getSlug());
			getCategoryPosts(category, i, rowItems);
		} catch (Exception e) {
