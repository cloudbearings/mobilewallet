...
public class CustomerMainActivity extends Activity {
	...
	CustComplaintsFragment complaintFragment;
	CustClosedComplaints closedComplaintsFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		navMenuTitles = getResources().getStringArray(R.array.nav_drawer_customer_items);

		// nav drawer icons from resources
		navMenuIcons = getResources()
				.obtainTypedArray(R.array.nav_drawer_customer_icons);
	...
	private void displayView(int position) {
		...
		switch (position) {
		case 0:
		    complaintFragment = CustComplaintsFragment.newInstance();
			fragment = complaintFragment;
			break;
		case 1:
		    closedComplaintsFragment = CustClosedComplaints.getInstance();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
	    if(resultCode == RESULT_OK && (requestCode == 2 || requestCode ==3 || requestCode ==4 || requestCode == 5) && complaintFragment != null){
